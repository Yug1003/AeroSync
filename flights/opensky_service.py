...
# OpenSky Network Bounding Box for Ahmedabad (AMD / VAAH) Airspace
OPENSKY_URL = "https://opensky-network.org/api/states/all?lamin=22.2&lamax=23.8&lomin=71.8&lomax=73.4"
